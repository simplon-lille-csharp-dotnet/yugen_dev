...
namespace yugen_dev
{
    public class AdminReviewController : Controller
    {
        ...
        public AdminReviewController(YugenContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Message,Rating")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Message,Rating")] Review review)
        {
            if (id != review.Id)
            {
                return NotFound();
